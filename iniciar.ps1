...
Start-Process powershell -ArgumentList @(
    "-NoExit",
    "-Command",
    "Set-Location '$Frontend'; Write-Host '[FRONTEND] Next.js iniciando...' -ForegroundColor Magenta; npm run dev -- --port 3004"
) -WindowStyle Normal

Write-OK "Frontend iniciando na porta 3004 (nova janela)."
